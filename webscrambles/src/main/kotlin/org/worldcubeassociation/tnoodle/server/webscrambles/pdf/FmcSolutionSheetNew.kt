...
open class FmcSolutionSheetNew(request: ScrambleRequest, globalTitle: String?, locale: Locale) : FmcSheet(request, globalTitle, locale) {
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            ...
            val sheet = FmcSolutionSheetNew(scrRequest, "FMC TNoodle 2019", Translate.DEFAULT_LOCALE)
