    ...
    override fun DocumentBuilder.writeContents() {
        ...
        for (scramblePageChunk in scrambleRowPages) {
            page {
                ...
                val unscrambledPuzzle = scramblingPuzzle.drawScramble(null, null)
                val fittingSize = scramblingPuzzle.getPreferredSize(100, 2 * marginBottom / 3) // TODO magic number

                footerImage = SvgImage(unscrambledPuzzle, fittingSize)
